...
public class NotSelectedRow extends JDialog {
	...
	public NotSelectedRow() {
		...
		{
			JLabel lblPleaseSelectA = new JLabel("Please select a value you desire first.");
			...
			lblPleaseSelectA.setBounds(5, 96, 426, 37);
